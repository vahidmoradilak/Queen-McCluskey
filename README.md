...
Then if they merge into a larger cube, they merge. The non-integrated cube is considered the main implicant (PI=Prime Implicant) and the main implant, which contains at least one essential or maximum material, is considered the basic implicant (EPI= Essential Prime Implicant).
